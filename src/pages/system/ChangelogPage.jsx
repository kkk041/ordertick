...
const CHANGELOG = [
  {
    ...
    items: [
      {
        type: 'feat',
        text: '新增接单方案管理：可以在设置里维护多个计费方案，并在接单、补录、快速补入和历史编辑时直接选择。',
      },
      {
        type: 'feat',
        text: '新增自定义阶梯计费，支持按时间段设置计费小时，也可以给某个时间段设置固定结算金额。',
      },
      {
        type: 'feat',
        text: '报单模板升级为多模板：设置页可以新增、编辑、删除报单模板，订单会记录使用的是哪个报单模板。',
      },
      {
        type: 'feat',
        text: '今日订单表格和历史订单表格新增“报单模板”列，查账时能直接看出每单用了哪个模板。',
      },
      {
        type: 'feat',
        text: '复制报单时会按订单绑定的报单模板生成，不再只能使用全局单一模板。',
      },
      {
        type: 'feat',
        text: '“今日打气”从语录改为古诗词展示，展示诗词名、作者、朝代、诗句和译文，并接入 3000+ 首本地离线诗词库。',
      },
      {
        type: 'improve',
        text: '优化菜单切换时的页面挂载方式，减少切换到数据图表页面时的闪烁感。',
      },
      {
        type: 'improve',
        text: '数据图表首次加载时不再强行动画，避免页面初始化时出现不必要的数值跳动。',
      },
      {
        type: 'improve',
        text: '设置页重新整理了接单方案和报单模板的编辑界面，补充了未保存离开提醒，减少误操作丢配置。',
      },
      {
        type: 'chore',
        text: '今日打气相关代码已加 HACK 标记：当前方案先满足本地诗词库与每日轮换，后续会继续重做 UI 和交互。',
      },
    ],
  },
  {
